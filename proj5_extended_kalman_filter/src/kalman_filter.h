...
public:
     ...
     * @param isRadarData If the measurement is from radar or not (lidar)
     */
    void Update(const Eigen::VectorXd &z, const bool isRadarData);
    ...
    // measurement covariance matrix for lidar data
